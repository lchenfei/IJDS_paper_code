#' RF-VS Method for Importance Sampling Variable Selection - Example 4
#' 
#' Uses Random Forest with greedy CE ordering and validation-based subset selection (D=50).
#'
